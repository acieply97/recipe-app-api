...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_partial_update(self):
        ...
        original_link = 'https://recipe-example.com'  # It's used for checking partial update is not change the variable
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        recipe.refresh_from_db()  # Django is not refreshing after patching
    ...
    def test_recipe_other_users_recipe_error(self):
        """Test trying to dleete another users recipe gives error"""
        new_user = create_user(email='user2@example.com', password='pssword123')
